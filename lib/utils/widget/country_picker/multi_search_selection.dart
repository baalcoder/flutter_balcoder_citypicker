...
import 'package:flutter_balcoder_citypicker/utils/widget/country_picker/helpers/get_item.dart';
...
class MultipleSearchSelection<T> extends StatefulWidget {
  ...
  factory MultipleSearchSelection({
    ...
    String hintText = 'Escriba aquí para buscar',
  ...
  const MultipleSearchSelection._({
    ...
    this.hintText = 'Escriba aquí para buscar',
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (pickedItems.length > 1 && (widget.showClearAllButton ?? true))
          Row(
            children: [
              Spacer(),
              GestureDetector(
